				...
				<div class="container" id="myInfo">			
					<div class="col-lg-8 my-5 mx-auto">
						<div class="p-4">
							...
							<form class="user" action="mUpdateForm.me" method="post" enctype="Multipart/form-data">
								...
								<div class="form-group">
									...
									<button type="button" class="btn btn-secondary btn-user btn-block" onclick="deleteMember()">회원 탈퇴</button>
								</div>
							</form>
						</div>
					</div>
