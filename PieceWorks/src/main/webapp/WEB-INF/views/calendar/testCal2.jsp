...
<head>
    ...
    <link href="resource/css/sb-admin-2.min.css" rel="stylesheet"> <!-- 캘린더 Modal오픈 안됨. 충돌부분 찾기!! -->
<!-- </head> -->
<!-- <head> -->
<!-- 	<meta charset="utf-8" /> -->
<!--     <meta http-equiv="X-UA-Compatible" content="IE=edge"> -->
<!--     <link rel=" shortcut icon" href="image/favicon.ico"> -->
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
 	...
 	<link rel="stylesheet" href="resource/CalendarTest2/vendor/css/bootstrap.min.css"> <!-- 얘를 수정해야 css충돌로 크기 작아지는거 해결 가능 -->
	<link rel="stylesheet" href='resource/CalendarTest2/vendor/css/select2.min.css' />
    <link rel="stylesheet" href="resource/CalendarTest2/css/main.css"> <!-- body padding 0px로 수정완료 -->
</head>
<body id="page-top">
...
<!-- 기능 작성 시작 부분 -->
					...
					<div class="container-fluid">
                	    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    	    <h1 class="h3 mb-0 text-gray-800">캘린더 테스트2222</h1>
                    	</div>
